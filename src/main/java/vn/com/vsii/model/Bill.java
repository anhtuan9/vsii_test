...
public class Bill {
    ...
    public BillStatus getTrans_status_code() {
        return trans_status_code;
    }

    public void setTrans_status_code(BillStatus trans_status_code) {
        this.trans_status_code = trans_status_code;
    }
